...
//转盘电机速度环PID参数
#define ROTARY_SPEED_PID_KP 120.0f
#define ROTARY_SPEED_PID_KI 1.1f
#define ROTARY_SPEED_PID_KD 3.5f
#define ROTARY_SPEED_PID_MAX_OUT 25000.0f
#define ROTARY_SPEED_PID_MAX_IOUT 25000.0f
//转盘电机速度环微分器带宽
#define ROTARY_SPEED_PID_BANDWIDTH 30.0f
//转盘电机位置环PID参数
#define ROTARY_POSITION_PID_KP 180.0f
#define ROTARY_POSITION_PID_KI 0.0f
#define ROTARY_POSITION_PID_KD 19.0f
#define ROTARY_POSITION_PID_MAX_OUT 300.0f
#define ROTARY_POSITION_PID_MAX_IOUT 250.0f
//转盘电机位置环微分器带宽
#define ROTARY_POSITION_PID_BANDWIDTH 30.0f
//转盘电机控制器采样时间
#define ROTARY_POSITION_PID_TIME_CONS 0.001f
...
//转盘电机零点编码值
#define ROTARY_ZERO_POINT_ECD 2633
...
#define ROTARY_ANGLE_TOLERANCE 0.0038f
